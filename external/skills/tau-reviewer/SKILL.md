...
your unread agent inbox messages, and the active/queued work streams you
...
| `inbox.message`                  | an agent wrote to your inbox (`senderId`, `subject`)                                                                      | `tau inbox list --json`, read it, `tau inbox read <id>`. Reply through the manager unless the agent asked you directly.                                                                                                         |
