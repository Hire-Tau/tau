 ...
 */
export interface ReadRangeHint {
	/** 1-indexed line number to start reading from. */
	offset?: number;
	/** Maximum number of lines requested by the caller. */
	limit?: number;
	/** Byte budget needed after the requested starting line. */
	maxBytes?: number;
}

export interface ReadOperations {
	/** Read file contents as a Buffer. Range hints are advisory. */
