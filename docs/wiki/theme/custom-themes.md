...
| Swatch                             | `--swatch-secondary`, `--swatch-tertiary` (the colours theme swatches blend with the primary)                  | The palette's own secondary and tertiary; when unset, the primary rotated +60° / −60°. Built-ins define their own.                                                                                                                                                                                                                                                                                                    |
