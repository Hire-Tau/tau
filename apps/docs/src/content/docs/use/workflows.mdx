...
The **Follow code changes** option routes review, CI, and merge updates to the current delivery owner. The flow preview shows the code-hosting connection. Updates do not approve work or bypass pauses and waits.
