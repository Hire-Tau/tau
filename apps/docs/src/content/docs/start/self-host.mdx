...
Approve the device in your browser. If you previously exported `TAU_PASSWORD` in this shell, unset it before browser-based login so it does not select the old password flow. See the [CLI reference](/reference/cli/) for backend selection.
