...
// Brand mark from Simple Icons (CC0): https://raw.githubusercontent.com/simple-icons/simple-icons/14.0.0/icons/railway.svg
export function RailwayIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
