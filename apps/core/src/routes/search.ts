...
function withinScope(column: SQL, scope: PermissionSquadScope): SQL {
  if (scope.kind === 'some')
...
/** Authorization, matching, ranking and the global entity limit all run before rows leave the database. */
