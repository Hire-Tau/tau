...
async function repairFamily(
  ...
  // Append-only families keep immutable identity/authority and are never deleted.
  // Their presentation is regenerated by the source scan above; the projection
  // anti-join pass has no additional missing-source deletions to repair.
